        ...
        <ul class="dashboard-navigation__list">
            @foreach ($sections as $section)
                <li class="dashboard-navigation__item js-search-index">
                    <span class="dashboard-navigation__toggle js-component-category">{{ ucfirst($section['name']) }}
                        <svg class="dashboard-navigation__toggle-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
                        ...
                        @foreach ($section['items'] as $view => $name)
                            <li>
                                <a class="dashboard-navigation__link js-component-link js-search-index" target="preview" href="{{ route('styleguide.show', $view) }}">{{ $name }}</a>
                                    <a class="dashboard-navigation__link-svg js-component-external-link" target="_blank" href="{{ route('styleguide.show', $view) }}">
                                        <svg id="external-link" viewBox="0 0 24 24" width="100%" height="100%"><title>external-link</title><path d="M18.277 6.321a1.1 1.1 0 0 0-1.556 0L15 8.043l-.308-.308c-1.168-1.168-3.216-1.168-4.384 0l-4.172 4.172c-.584.584-.906 1.363-.906 2.192s.322 1.608.906 2.192l.308.308-1.722 1.722a1.1 1.1 0 1 0 1.556 1.556L8 18.155l.308.308c.584.584 1.362.906 2.192.906s1.608-.322 2.192-.906l4.172-4.172c.584-.584.906-1.362.906-2.192s-.322-1.608-.906-2.192l-.308-.308 1.722-1.722a1.1 1.1 0 0 0-.001-1.556zm-2.969 6.414l-4.172 4.172c-.168.168-.402.253-.636.253s-.468-.084-.636-.253l-.308-.308.722-.722a1.1 1.1 0 1 0-1.556-1.556L8 15.043l-.308-.308c-.168-.168-.261-.395-.261-.636s.093-.468.261-.636l4.172-4.172c.168-.168.394-.261.636-.261s.468.093.636.261l.308.308-.722.722a1.1 1.1 0 1 0 1.556 1.556l.722-.722.308.308c.168.168.261.395.261.636s-.093.468-.261.636z"></path></svg>
                                    </a>
                            </li>
                        @endforeach
                    </ul>
...
<div class="dashboard-frame">
    <div class="dashboard-frame__header-wrapper">
        <div class="dashboard-frame__header">
            ...
            <div class="dashboard-frame__header--combine">
                <a class="dashboard-frame__link dashboard-frame__link--external slide-button slide-button--primary" href="#" target="_blank"><svg role="img" class="icon"><svg id="external-link" viewBox="0 0 24 24" width="100%" height="100%"><title>external-link</title><path d="M18.277 6.321a1.1 1.1 0 0 0-1.556 0L15 8.043l-.308-.308c-1.168-1.168-3.216-1.168-4.384 0l-4.172 4.172c-.584.584-.906 1.363-.906 2.192s.322 1.608.906 2.192l.308.308-1.722 1.722a1.1 1.1 0 1 0 1.556 1.556L8 18.155l.308.308c.584.584 1.362.906 2.192.906s1.608-.322 2.192-.906l4.172-4.172c.584-.584.906-1.362.906-2.192s-.322-1.608-.906-2.192l-.308-.308 1.722-1.722a1.1 1.1 0 0 0-.001-1.556zm-2.969 6.414l-4.172 4.172c-.168.168-.402.253-.636.253s-.468-.084-.636-.253l-.308-.308.722-.722a1.1 1.1 0 1 0-1.556-1.556L8 15.043l-.308-.308c-.168-.168-.261-.395-.261-.636s.093-.468.261-.636l4.172-4.172c.168-.168.394-.261.636-.261s.468.093.636.261l.308.308-.722.722a1.1 1.1 0 1 0 1.556 1.556l.722-.722.308.308c.168.168.261.395.261.636s-.093.468-.261.636z"></path></svg></svg>
                </a>

                 <a class="dashboard-frame__link dashboard-frame__link--qr slide-button slide-button--primary" href="#" target="_blank">
                    <svg viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"><path d="M10 4H6a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zm0 6H6V6h4v4zM9 9H7V7h2v2zM10 18H6a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2v-4a2 2 0 0 0-2-2zm0 6H6v-4h4v4zm-1-1H7v-2h2v2zM24 4h-4a2 2 0 0 0-2 2v4a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2zm0 6h-4V6h4v4zm-1-1h-2V7h2v2zM14 6h2v2h-2zM14 10h2v2h-2zM14 14h2v2h-2zM10 14h2v2h-2zM6 14h2v2H6zM18 14h2v2h-2zM22 14h2v2h-2zM16 16h2v2h-2zM20 16h2v2h-2zM18 18h2v2h-2zM14 18h2v2h-2zM16 20h2v2h-2zM18 22h2v2h-2zM16 24h2v2h-2zM24 16h2v2h-2zM24 20h2v2h-2zM20 20h2v2h-2zM20 24h2v2h-2zM22 22h2v2h-2zM22 18h2v2h-2zM14 22h2v2h-2z"/></svg>
                </a>
...
<script>
    ...
    components.forEach(component => {
        component.addEventListener('click', function() {
            ...
            document.querySelectorAll('.dashboard-frame__title').forEach(item => {
                item.innerHTML = component.innerHTML;
            })
            document.querySelector('.dashboard-frame__link--external').href = component.href;
            document.querySelector('.dashboard-frame__link--qr').href = `https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=${component.href}`;
        })
    });

    const externalComponents = [...document.querySelectorAll('.js-component-external-link')];
